# IO.Swagger.Model.EnvelopeDefinition
## Properties
...
**EmailSettings** | [**EnvelopeEmailSettings**](EnvelopeEmailSettings.md) | This optional complex element allows sender to override some envelope email setting information. This can be used to override the Reply To email address and name associated with the envelope and to override the BCC email addresses to which an envelope is sent. When the emailSettings information is used for an envelope, it only applies to that envelope. **IMPORTANT:** The emailSettings information is not returned in the GET for envelope status. Use GET /email_settings to return information about the emailSettings. | [optional] 
...
**EventNotification** | [**EventNotification**](EventNotification.md) | This optional object is used to register a webhook that will receive status changes for this envelope. | [optional] 
...
**Notification** | [**Notification**](Notification.md) | An optional complex element that specifies the notification options for the envelope. | [optional] 
...
**Recipients** | [**EnvelopeRecipients**](EnvelopeRecipients.md) | Specifies the envelope recipients. | [optional] 
