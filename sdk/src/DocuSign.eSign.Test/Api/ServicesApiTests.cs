...
namespace DocuSign.eSign.Test.Api
{
    ...
    public class ServicesApiTests
    {
        ...
        /// <summary>
        /// Test ServiceInformationGetServiceInformation
        /// </summary>
        [Test]
        public void ServiceInformationGetServiceInformationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ServiceInformationGetServiceInformation();
            //Assert.IsInstanceOf<Services> (response, "response is Services");
        }
